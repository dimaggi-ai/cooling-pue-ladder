# Cover artwork — cooling-pue-ladder

![A graphite compute module joined to a radiator by a copper cold plate and muted blue coolant pipes.](social-preview-v1.jpg)
...
Open [repository settings](https://github.com/dimaggi-ai/cooling-pue-ladder/settings),
...
Alt text: A graphite compute module joined to a radiator by a copper cold plate and muted blue coolant pipes.
...
Subject: the physical cooling infrastructure beneath usable compute. One compact graphite compute module with fine vertical cooling fins sits next to one thin upright pale-metal heat-exchanger panel, connected by exactly two clean, gently curved coolant tubes. One small copper cold plate is visible on the compute module. Use only a very subtle desaturated blue on the two tubes. An elegant closed cooling-loop sculpture, with no water droplets, steam, fans spinning, cutaway fluids, symbols or excessive pipes. Three main forms, ample air around them.
```
